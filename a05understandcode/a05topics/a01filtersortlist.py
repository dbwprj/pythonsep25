...
operational_machines = [machine for key, machine in machine_list if machine.status == "Operational"]
print("\nOperational Machines:")
for machine in operational_machines:
    print(machine)

# Filter machines with production rate greater than 100
high_production_machines = [machine for key, machine in machine_list if machine.production_rate > 100]
print("\nMachines with Production Rate > 100:")
for machine in high_production_machines:
    print(machine)

# Filter machines that are "Under Maintenance"
maintenance_machines = [machine for key, machine in machine_list if machine.status == "Under Maintenance"]
